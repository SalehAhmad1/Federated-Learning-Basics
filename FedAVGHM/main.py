...
if __name__ == "__main__":
    ...
    client_models = [ClientModel(server_model.pubkey,num_features,num_labels) for _ in range(num_clients)]
    ...
    # server_model_loaded = load_model(ServerModel, args=(server_model.pubkey,num_features,num_labels), filepath='./ServerModel.pth')
